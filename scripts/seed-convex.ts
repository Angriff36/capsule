...
export async function seedConvex(deploymentUrl: string): Promise<void> {
  ...
  // PackListItem has multiple initialization commands (addItem, remove); using the selected initialization command: addItem.
...
export const MANIFEST_CONVEX_SEED_BINDING = {
  ...
  "entities": [
    ...
    },
    {
      ...
      "createMutation": "EventVehicleAssignment_createViaAssign",
      "rowCount": 2
    },
    {
    ...
    },
    {
      ...
      "createMutation": "ServiceStyleKitItem_createViaAdd",
      "rowCount": 2
    },
    {
      "entity": "ShareLink",
