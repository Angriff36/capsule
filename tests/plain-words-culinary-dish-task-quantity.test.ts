...
describe("plain words on leftover culinary dish task quantity copy", () => {
  it("keeps the dish task quantity refusal free of jargon", () => {
    ...
    expect(visible).not.toContain("Dish task quantity must be positive");
    ...
    expect(mutations).not.toContain("Dish task quantity must be positive");
