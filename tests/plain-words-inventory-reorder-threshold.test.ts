...
describe("plain words on leftover stock reorder threshold copy", () => {
  it("keeps the negative reorder threshold refusals free of jargon", () => {
    ...
    expect(visible).not.toContain("Reorder threshold cannot be negative");
    ...
    expect(mutations).not.toContain("Reorder threshold cannot be negative");
