...
> **Correction (2026-07-20):** Capsule pinned exact registry **`3.6.33`** (authenticated Convex command HTTP dispatcher: selected init→`createVia*`, instance `docId`/`version`). Registry-only; no `file:` / `.tgz`.
>
