...
| Proof            | Runtime: `tests/proofs/quality-check-fail-block.runtime.test.ts` (`QualityCheckFailed → PrepTask.markBlocked`). Guard: `generated/proof/guard.production.json` + `bun run check:production-manifest`. |
