...
| --------------------------------------------------- | ----------------------------------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------------------ |
| [Organization & identity](organization-identity.md) | Organization, Person                                                                | Organization/team settings               | Generated; no authored workspace                                   |
...
| [Culinary](culinary.md)                             | Ingredient, Recipe, RecipeIngredient, Dish, Menu, EventDish                         | `/kitchen`                               | Generated; placeholder route                                       |
| [Inventory](inventory.md)                           | StorageLocation, InventoryItem, InventoryReservation, IngredientDemand, WasteRecord | `/inventory`                             | Generated; planned UI                                              |
| [Procurement](procurement.md)                       | Vendor, VendorOrder, VendorOrderLine, PurchaseNeed                                  | `/procurement` or Inventory subworkspace | Generated; planned UI; reaction blockers                           |
| [Production & quality](production-quality.md)       | PrepTask, ProductionBatch, QualityCheck, Incident, EventAllergenCheck               | `/kitchen/production`, event execution   | Generated; planned UI; reaction blocker                            |
| [Workforce](workforce.md)                           | EventAssignment, Shift, AvailabilityWindow, TimeRecord, Qualification               | `/staff`                                 | Generated; planned UI                                              |
| [Logistics](logistics.md)                           | PackList, PackListItem, Delivery                                                    | `/logistics`                             | Generated; planned UI; cancellation reaction blocker               |
| [Commercial & billing](commercial-billing.md)       | ClientContact, Proposal, Contract, Invoice, Payment, PaymentMethod                  | `/clients`, `/finance`                   | Generated; planned UI; payment reaction blocker                    |
| [Closeout & reporting](closeout-reporting.md)       | EventCloseout, PayrollInput, SavedReportDefinition                                  | `/finance/closeout`, `/reports`          | Generated; planned UI                                              |
...
| [Projection status](../generation/projection-status.md)  | Current generated capability and blockers                    | Verified snapshot                                                    |
