...
| [Service style & packaging](service-style-packaging.md) | Dish.category, EventDish.serviceStyle, PackList templates, ServiceStyle | `/kitchen`, `/logistics` | READ BEFORE dish dedup/merge: service style drives packaging + pack-list selection; same-name dishes across styles are variants, not junk |
