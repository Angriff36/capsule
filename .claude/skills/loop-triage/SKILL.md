...
- This app is a live Manifest project generated by **Builder** (see
  ...
  proof-kit scripts' inputs) are NOT hand-fix items — report them as
  "needs Builder update-mode regen (`bun run manifest:regen`)"
  and let the human run the plan. Never suggest editing owned trees.
