...
export type EventDishRecipeSeed = z.infer<typeof EventDishRecipeSeedSchema>;
...
export const ExternalRecordLinkSchema = z.object({
  ...
  capsuleEntity: z.enum(["event_record", "contact", "lead", "menu", "venue", "payment", "invoice", "contract", "proposal", "client", "vendor", "person", "task", "batch", "order", "delivery", "stock", "location"]).default("contact"),
...
export const ImportRunSchema = z.object({
  ...
  datasetType: z.enum(["events", "contacts", "leads", "menus", "venues", "payments"]).default("events"),
...
// Command: setPrimaryRecipe on Dish
export const DishSetPrimaryRecipeParamsSchema = z.object({
  primaryRecipeId: z.string().min(1).optional(),
});

export type DishSetPrimaryRecipeParams = z.infer<typeof DishSetPrimaryRecipeParamsSchema>;
...
// Command: seed on EventDishRecipeSeed
export const EventDishRecipeSeedSeedParamsSchema = z.object({
  eventId: z.string().min(1),
...
export type EventDishRecipeSeedSeedParams = z.infer<typeof EventDishRecipeSeedSeedParamsSchema>;
...
export const ExternalRecordLinkLinkParamsSchema = z.object({
  ...
  recordType: z.string(),
  externalId: z.string(),
  capsuleEntity: z.enum(["event_record", "contact", "lead", "menu", "venue", "payment", "invoice", "contract", "proposal", "client", "vendor", "person", "task", "batch", "order", "delivery", "stock", "location"]),
  capsuleId: z.string(),
...
export const ImportRunStartParamsSchema = z.object({
  ...
  datasetType: z.enum(["events", "contacts", "leads", "menus", "venues", "payments"]),
  actorId: z.string().optional(),
...
// Command: capture on RecipeSnapshot
export const RecipeSnapshotCaptureParamsSchema = z.object({
  recipeId: z.string().min(1),
...
export type RecipeSnapshotCaptureParams = z.infer<typeof RecipeSnapshotCaptureParamsSchema>;
