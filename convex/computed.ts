...
/** Self-only computed fields for ProductionBatch. Pass the stored document. */
export function computeProductionBatch(doc: Record<string, any>): Record<string, any> {
  return {
    yieldVariance: ((doc.actualYield != null) ? (doc.actualYield - doc.plannedYield) : null),
    varianceRatio: ((doc.actualYield != null) ? ((doc.actualYield - doc.plannedYield) / doc.plannedYield) : null),
    fulfillmentRatio: ((doc.actualYield != null) ? (doc.actualYield / doc.plannedYield) : null),
  };
}
