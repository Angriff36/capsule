...
export interface ExternalRecordLinkLinkClientInput {
  ...
  capsuleEntity: "event_record" | "contact" | "lead" | "menu" | "venue" | "payment" | "invoice" | "contract" | "proposal" | "client" | "vendor" | "person" | "task" | "batch" | "order" | "delivery" | "stock" | "location";
  capsuleId: string;
  verified?: boolean;
...
export interface ImportRunStartClientInput {
  ...
  /** Allowed: "events" | "contacts" | "leads" | "menus" | "venues" | "payments" */
  datasetType: "events" | "contacts" | "leads" | "menus" | "venues" | "payments";
  actorId?: string;
  checksum?: string;
}
...
export const PerformanceReviewRecordCapability = {
  ...
  instanceCommand: true,
  clientParameterNames: ["personId","reviewerId","reviewDate","reliabilityRating","qualityRating","teamworkRating","notes"],
  serverParameterNames: [],
...
// --- RecipeSnapshot.capture ---
export interface RecipeSnapshotCaptureClientInput {
  recipeId: string;
...
export const RecipeSnapshotCaptureCapability = {
  capabilityId: "RecipeSnapshot.capture",
  entity: "RecipeSnapshot",
  command: "capture",
  route: "/api/manifest/RecipeSnapshot/commands/capture",
  instanceCommand: true,
  clientParameterNames: ["recipeId","versionNumber","capturedByName","changeSummary","snapshot"],
  serverParameterNames: [],
  emits: ["RecipeSnapshotCaptured"],
} as const;

/**
 * Build command input for RecipeSnapshot.capture.
 * Client fields only; server-owned fields are injected separately.
 */
export function bindRecipeSnapshotCaptureInput(client: RecipeSnapshotCaptureClientInput): Record<string, unknown> {
  return { ...client };
}

/** Invalidation targets after a successful RecipeSnapshot.capture. */
export const RecipeSnapshotCaptureInvalidation = [
  {
    "kind": "entityList",
    "entity": "RecipeSnapshot",
    "queryKeyHint": "queryKeys.recipeSnapshot.lists()",
    "label": "entity list"
  },
  {
    "kind": "entityDetail",
    "entity": "RecipeSnapshot",
    "queryKeyHint": "queryKeys.recipeSnapshot.detail(id)",
    "label": "entity detail"
  }
] as const;
