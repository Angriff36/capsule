...
// --- EventDish.restore ---
export type EventDishRestoreClientInput = Record<string, never>;

export const EventDishRestoreCapability = {
  capabilityId: "EventDish.restore",
  entity: "EventDish",
  command: "restore",
  route: "/api/manifest/EventDish/commands/restore",
  instanceCommand: true,
  clientParameterNames: [],
  serverParameterNames: [],
  emits: ["EventDishRestored"],
} as const;

/**
 * Build command input for EventDish.restore.
 * Client fields only; server-owned fields are injected separately.
 */
export function bindEventDishRestoreInput(client: EventDishRestoreClientInput): Record<string, unknown> {
  return { ...client };
}

/** Invalidation targets after a successful EventDish.restore. */
export const EventDishRestoreInvalidation = [
  {
    "kind": "entityList",
    "entity": "EventDish",
    "queryKeyHint": "queryKeys.eventDish.lists()",
...
// --- EventIngredientContribution.reinstate ---
export type EventIngredientContributionReinstateClientInput = Record<string, never>;

export const EventIngredientContributionReinstateCapability = {
  capabilityId: "EventIngredientContribution.reinstate",
  entity: "EventIngredientContribution",
  command: "reinstate",
  route: "/api/manifest/EventIngredientContribution/commands/reinstate",
  instanceCommand: true,
  clientParameterNames: [],
  serverParameterNames: [],
  emits: ["EventIngredientContributionRecorded"],
...
/**
 * Build command input for EventIngredientContribution.reinstate.
 * Client fields only; server-owned fields are injected separately.
 */
export function bindEventIngredientContributionReinstateInput(client: EventIngredientContributionReinstateClientInput): Record<string, unknown> {
  return { ...client };
}

/** Invalidation targets after a successful EventIngredientContribution.reinstate. */
export const EventIngredientContributionReinstateInvalidation = [
  {
    "kind": "entityList",
    "entity": "EventIngredientContribution",
    "queryKeyHint": "queryKeys.eventIngredientContribution.lists()",
...
// --- PrepTask.reopen ---
export type PrepTaskReopenClientInput = Record<string, never>;

export const PrepTaskReopenCapability = {
  capabilityId: "PrepTask.reopen",
  entity: "PrepTask",
  command: "reopen",
  route: "/api/manifest/PrepTask/commands/reopen",
  instanceCommand: true,
  clientParameterNames: [],
  serverParameterNames: [],
  emits: ["PrepTaskReopened"],
} as const;

/**
 * Build command input for PrepTask.reopen.
 * Client fields only; server-owned fields are injected separately.
 */
export function bindPrepTaskReopenInput(client: PrepTaskReopenClientInput): Record<string, unknown> {
  return { ...client };
}

/** Invalidation targets after a successful PrepTask.reopen. */
export const PrepTaskReopenInvalidation = [
  {
    "kind": "entityList",
    "entity": "PrepTask",
    "queryKeyHint": "queryKeys.prepTask.lists()",
...
// --- WasteRecord.unvoid ---
export type WasteRecordUnvoidClientInput = Record<string, never>;

export const WasteRecordUnvoidCapability = {
  capabilityId: "WasteRecord.unvoid",
  entity: "WasteRecord",
  command: "unvoid",
  route: "/api/manifest/WasteRecord/commands/unvoid",
  instanceCommand: true,
  clientParameterNames: [],
  serverParameterNames: [],
  emits: ["WasteUnvoided"],
...
/**
 * Build command input for WasteRecord.unvoid.
 * Client fields only; server-owned fields are injected separately.
 */
export function bindWasteRecordUnvoidInput(client: WasteRecordUnvoidClientInput): Record<string, unknown> {
  return { ...client };
}

/** Invalidation targets after a successful WasteRecord.unvoid. */
export const WasteRecordUnvoidInvalidation = [
  {
    "kind": "entityList",
    "entity": "WasteRecord",
    "queryKeyHint": "queryKeys.wasteRecord.lists()",
...
/** Proven lifecycle transitions for WasteRecord.unvoid. */
export const WasteRecordUnvoidLifecycle = [
  {
    "property": "status",
    "from": "pending",
    "to": "recorded",
