...
export const ReasonCopy = {
  retireComponent: {
    title: "Retire recipe",
    description: "Say why this recipe is leaving the active book.",
  ...
  removeLine: {
    title: "Remove line",
    description: "Say why this line is being removed.",
  ...
  cancelNeed: {
    ...
    description: "Say why this need is leaving the open queue.",
  ...
  cancelOrder: {
    ...
    description: "Say why this order is being cancelled.",
    label: "Cancellation reason",
  ...
  terminateVendorContract: {
    ...
    description: "Say why this agreement is ending before its end date.",
  ...
  cancelShift: {
    title: "Cancel shift",
    description: "Say why this shift is being cancelled.",
    label: "Cancellation reason",
  ...
  cancelPackList: {
    ...
    description: "Say why this pack list is leaving the active dispatch trace.",
    label: "Cancellation reason",
  ...
  cancelDelivery: {
    ...
    description: "Say why this delivery will not run.",
    label: "Cancellation reason",
  ...
  failDelivery: {
    ...
    description: "Say why transit or handoff failed.",
  ...
  failPayment: {
    ...
    description: "Say why this payment did not clear.",
    label: "Failure reason",
  ...
  refundPayment: {
    ...
    description: "Adds a refund against a settled payment.",
    label: "Refund reason",
  ...
  removeContact: {
    ...
    description: "Say why this contact is leaving the client roster.",
    label: "Removal reason",
  ...
  releaseReservation: {
    ...
    description: "Say why reserved stock is being released.",
