...
export function VenuesPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {showForm && (
        <form onSubmit={submit} className="space-y-4 rounded-md bg-inset p-4">
        ...
        <div className="overflow-hidden rounded-md border border-line">
          <table className="min-w-full divide-y divide-line">
            <thead className="bg-inset">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium uppercase text-ink-3">
                  Name
                </th>
                <th className="px-4 py-3 text-left text-xs font-medium uppercase text-ink-3">
                  Type
                ...
                <th className="px-4 py-3 text-right text-xs font-medium uppercase text-ink-3">
                  Actions
                </th>
              </tr>
            </thead>
