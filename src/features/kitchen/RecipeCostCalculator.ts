...
export interface CalculateRecipeCostInput {
  lines: RecipeCostLineInput[];
...
export function calculateRecipeCost({
  ...
  batchMultiplier,
  yieldQuantity,
}: CalculateRecipeCostInput): RecipeCostSummary {
  ...
  const costLines = lines.map<RecipeCostLineResult>((line) => {
    ...
    const quantityInPricingUnits = convertRecipeQuantity(
